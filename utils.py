...
def write_log(OUTPUT_DIR, N, M, LV, GV, GAMMA, EPSILON, layer_dims, weight_decay, lr, NN_weights, NN_biases, METHOD, EPOCHS, makespan, Tsum, Tmax, Tn, calc_time, epoch, MILP_objval, MILP_calctime):
